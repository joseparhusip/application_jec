// duochrome_test_page.dart (KODE DENGAN GAMBAR DIPERBESAR)

import 'package:flutter/material.dart';

class DuochromeTestPage extends StatefulWidget {
  const DuochromeTestPage({super.key});

  @override
  State<DuochromeTestPage> createState() => _DuochromeTestPageState();
}

class _DuochromeTestPageState extends State<DuochromeTestPage> {
  ...
  List<Widget> _buildTestFlow() {
    return [
      ...
      _TestQuestionScreen(
        imageAsset: 'assets/icons/duochrome1.png',
      ...
      _TestQuestionScreen(
        imageAsset: 'assets/icons/duochrome2.png',
...
// WIDGET UNTUK HALAMAN PERTANYAAN TES DUOCHROME
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Image.asset(
                  imageAsset,
                  height: 250, // Diperbesar dari 200 menjadi 250
                  errorBuilder: (context, e, s) => Container(
                    height: 250, // Disesuaikan
                    width: 250,  // Disesuaikan
                ...
                const Text(
                  "Apakah lingkaran kanan lebih jelas dari pada lingkaran kiri?",
                  textAlign: TextAlign.center,
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500, color: Color(0xFF2E6B65)),
                ),
              ],
            ),
          ),
...
class _ResultsScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final bool hasProblem = answers.containsValue(true);

    String resultText;
    if (hasProblem) {
      resultText = "Ada indikasi kelainan refraksi pada mata Anda. Disarankan untuk konsultasi lebih lanjut.";
    } else {
      resultText = "Hasil menunjukkan bahwa mata Anda tidak memiliki indikasi kelainan refraksi.";
    }
