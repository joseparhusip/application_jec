...
class FlacsPage extends StatefulWidget {
  const FlacsPage({super.key});

  @override
  State<FlacsPage> createState() => _FlacsPageState();
}

class _FlacsPageState extends State<FlacsPage> {
      ...
      builder: (context, child) {
        return Theme(
          data: Theme.of(context).copyWith(
            ...
            // FIX: Menggunakan DialogThemeData, bukan DialogTheme
        ...
        children: [
          ...
          Container(
            ...
            child: SvgPicture.asset(
              'assets/icons/iconsmenu/flacs.svg',
              width: 24,
              height: 24,
              colorFilter:
        ...
        onPressed: hasData
            ? () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(
                        'Mencari layanan FLACS di ${_rsController.text}$doctorInfo'),
